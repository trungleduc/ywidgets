...
# -*- coding: utf-8 -*-
#
# yWidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'yWidgets', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'yWidgets.tex', 'yWidgets Documentation',
     'Duc Trung Le', 'manual'),
]
